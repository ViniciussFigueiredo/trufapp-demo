...
export function ModalMonth(props: MonthProps) {
    const { Salemonth, onCancel, onConfirm } = props;
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <div className="d-flex gap-2 align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#1A75FF" className="bi bi-calendar-month" viewBox="0 0 16 16">
                            ...
                            <h5 className="modal-title">Fechar o mês </h5>
                        </div>
                        <button type="button" onClick={onCancel} className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div className="modal-body">
                        <p>Tem certeza que deseja fechar o mês de <strong>{Salemonth}</strong></p>
                    </div>
